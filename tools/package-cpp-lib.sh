...
cp $BUILD_ROOT/lib/cpp/include/antaris_api_parser.h $DEB_OUTPUT_DIR/lib/antaris/include
cp $BUILD_ROOT/lib/cpp/include/antaris_can_api.h $DEB_OUTPUT_DIR/lib/antaris/include
cp $BUILD_ROOT/lib/cpp/include/antaris_api_i2c.h $DEB_OUTPUT_DIR/lib/antaris/include

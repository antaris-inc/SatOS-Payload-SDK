...
This directory contains a Payload Application to store health matric data using the C++ API.
...
```bash
cd examples/app-fs-cpp

# Builds your standalone application first 
docker build -t satos-payload-example-fs-app-cpp .
```

...
#define TRUETWIN_MODE_KEY                   "TRUETWIN_MODE"
...
char g_TRUETWIN_ENABLE = '1';        // TrueTwin is disabled by default
...
static void update_a_conf(char *conf_line)
{
    ...
    } else if (strcmp(a_conf.prop, TRUETWIN_MODE_KEY) == 0) {
        strcpy(&g_TRUETWIN_ENABLE, a_conf.value);
    }

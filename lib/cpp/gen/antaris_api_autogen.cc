...
displayAntarisApiCallbackFuncList(const void *obj)
{
    ...
    printf("gnss_eph_stop_response ==>\n");
    displayProcessRespGnssEphStopDataReq_Fptr((void *)&p->gnss_eph_stop_response);
    printf("gnss_eph_start_response ==>\n");
    displayProcessRespGnssEphStartDataReq_Fptr((void *)&p->gnss_eph_start_response);
    printf("gnss_eph_data ==>\n");
    displayProcessGnssEphData_Fptr((void *)&p->gnss_eph_data);

...
struct RespGetCurrentLocationParams {
    ...
    DOUBLE                                          longitude;                                       ///< @var current latitude
    DOUBLE                                          latitude;                                        ///< @var current longitude
    DOUBLE                                          altitude;                                        ///< @var current altitude
    FLOAT                                           sd_longitude;                                    ///< @var Standard Deviation latitude
    FLOAT                                           sd_latitude;                                     ///< @var Standard Deviation longitude
    FLOAT                                           sd_altitude;                                     ///< @var Standard Deviation altitude

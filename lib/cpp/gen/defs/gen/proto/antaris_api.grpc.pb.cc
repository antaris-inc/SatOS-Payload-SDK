...
AntarisapiApplicationCallback::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_PA_ProcessStageHmDataReq_(AntarisapiApplicationCallback_method_names[20], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status AntarisapiApplicationCallback::Stub::PA_ProcessStageHmDataReq(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::StageHmData& request, ::antaris_api_peer_to_peer::AntarisReturnType* response) {
  return ::grpc::internal::BlockingUnaryCall< ::antaris_api_peer_to_peer::StageHmData, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_PA_ProcessStageHmDataReq_, context, request, response);
}

void AntarisapiApplicationCallback::Stub::async::PA_ProcessStageHmDataReq(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::StageHmData* request, ::antaris_api_peer_to_peer::AntarisReturnType* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::antaris_api_peer_to_peer::StageHmData, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PA_ProcessStageHmDataReq_, context, request, response, std::move(f));
}

void AntarisapiApplicationCallback::Stub::async::PA_ProcessStageHmDataReq(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::StageHmData* request, ::antaris_api_peer_to_peer::AntarisReturnType* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PA_ProcessStageHmDataReq_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::antaris_api_peer_to_peer::AntarisReturnType>* AntarisapiApplicationCallback::Stub::PrepareAsyncPA_ProcessStageHmDataReqRaw(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::StageHmData& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::antaris_api_peer_to_peer::AntarisReturnType, ::antaris_api_peer_to_peer::StageHmData, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_PA_ProcessStageHmDataReq_, context, request);
}

::grpc::ClientAsyncResponseReader< ::antaris_api_peer_to_peer::AntarisReturnType>* AntarisapiApplicationCallback::Stub::AsyncPA_ProcessStageHmDataReqRaw(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::StageHmData& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncPA_ProcessStageHmDataReqRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
AntarisapiApplicationCallback::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< AntarisapiApplicationCallback::Service, ::antaris_api_peer_to_peer::StageHmData, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](AntarisapiApplicationCallback::Service* service,
             ::grpc::ServerContext* ctx,
             const ::antaris_api_peer_to_peer::StageHmData* req,
             ::antaris_api_peer_to_peer::AntarisReturnType* resp) {
               return service->PA_ProcessStageHmDataReq(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status AntarisapiApplicationCallback::Service::PA_ProcessStageHmDataReq(::grpc::ServerContext* context, const ::antaris_api_peer_to_peer::StageHmData* request, ::antaris_api_peer_to_peer::AntarisReturnType* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
AntarisapiPayloadController::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_PC_host_to_peer_fcm_operation_(AntarisapiPayloadController_method_names[16], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_PC_satos_pa_message_(AntarisapiPayloadController_method_names[17], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_PC_hm_data_rsp_(AntarisapiPayloadController_method_names[18], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status AntarisapiPayloadController::Stub::PC_hm_data_rsp(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::RespStageHmData& request, ::antaris_api_peer_to_peer::AntarisReturnType* response) {
  return ::grpc::internal::BlockingUnaryCall< ::antaris_api_peer_to_peer::RespStageHmData, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_PC_hm_data_rsp_, context, request, response);
}

void AntarisapiPayloadController::Stub::async::PC_hm_data_rsp(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::RespStageHmData* request, ::antaris_api_peer_to_peer::AntarisReturnType* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::antaris_api_peer_to_peer::RespStageHmData, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PC_hm_data_rsp_, context, request, response, std::move(f));
}

void AntarisapiPayloadController::Stub::async::PC_hm_data_rsp(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::RespStageHmData* request, ::antaris_api_peer_to_peer::AntarisReturnType* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PC_hm_data_rsp_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::antaris_api_peer_to_peer::AntarisReturnType>* AntarisapiPayloadController::Stub::PrepareAsyncPC_hm_data_rspRaw(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::RespStageHmData& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::antaris_api_peer_to_peer::AntarisReturnType, ::antaris_api_peer_to_peer::RespStageHmData, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_PC_hm_data_rsp_, context, request);
}

::grpc::ClientAsyncResponseReader< ::antaris_api_peer_to_peer::AntarisReturnType>* AntarisapiPayloadController::Stub::AsyncPC_hm_data_rspRaw(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::RespStageHmData& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncPC_hm_data_rspRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
AntarisapiPayloadController::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< AntarisapiPayloadController::Service, ::antaris_api_peer_to_peer::RespStageHmData, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](AntarisapiPayloadController::Service* service,
             ::grpc::ServerContext* ctx,
             const ::antaris_api_peer_to_peer::RespStageHmData* req,
             ::antaris_api_peer_to_peer::AntarisReturnType* resp) {
               return service->PC_hm_data_rsp(ctx, req, resp);
             }, this)));
}
...
::grpc::Status AntarisapiPayloadController::Service::PC_hm_data_rsp(::grpc::ServerContext* context, const ::antaris_api_peer_to_peer::RespStageHmData* request, ::antaris_api_peer_to_peer::AntarisReturnType* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");

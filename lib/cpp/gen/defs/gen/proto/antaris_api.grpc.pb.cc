...
AntarisapiApplicationCallback::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_PA_ProcessReqPayloadStats_(AntarisapiApplicationCallback_method_names[7], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status AntarisapiApplicationCallback::Stub::PA_ProcessReqPayloadStats(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::ReqPayloadStatsParams& request, ::antaris_api_peer_to_peer::AntarisReturnType* response) {
  return ::grpc::internal::BlockingUnaryCall< ::antaris_api_peer_to_peer::ReqPayloadStatsParams, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_PA_ProcessReqPayloadStats_, context, request, response);
}

void AntarisapiApplicationCallback::Stub::async::PA_ProcessReqPayloadStats(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::ReqPayloadStatsParams* request, ::antaris_api_peer_to_peer::AntarisReturnType* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::antaris_api_peer_to_peer::ReqPayloadStatsParams, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PA_ProcessReqPayloadStats_, context, request, response, std::move(f));
}

void AntarisapiApplicationCallback::Stub::async::PA_ProcessReqPayloadStats(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::ReqPayloadStatsParams* request, ::antaris_api_peer_to_peer::AntarisReturnType* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PA_ProcessReqPayloadStats_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::antaris_api_peer_to_peer::AntarisReturnType>* AntarisapiApplicationCallback::Stub::PrepareAsyncPA_ProcessReqPayloadStatsRaw(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::ReqPayloadStatsParams& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::antaris_api_peer_to_peer::AntarisReturnType, ::antaris_api_peer_to_peer::ReqPayloadStatsParams, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_PA_ProcessReqPayloadStats_, context, request);
}

::grpc::ClientAsyncResponseReader< ::antaris_api_peer_to_peer::AntarisReturnType>* AntarisapiApplicationCallback::Stub::AsyncPA_ProcessReqPayloadStatsRaw(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::ReqPayloadStatsParams& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncPA_ProcessReqPayloadStatsRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
AntarisapiApplicationCallback::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< AntarisapiApplicationCallback::Service, ::antaris_api_peer_to_peer::ReqPayloadStatsParams, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](AntarisapiApplicationCallback::Service* service,
             ::grpc::ServerContext* ctx,
             const ::antaris_api_peer_to_peer::ReqPayloadStatsParams* req,
             ::antaris_api_peer_to_peer::AntarisReturnType* resp) {
               return service->PA_ProcessReqPayloadStats(ctx, req, resp);
             }, this)));
}
...
::grpc::Status AntarisapiApplicationCallback::Service::PA_ProcessReqPayloadStats(::grpc::ServerContext* context, const ::antaris_api_peer_to_peer::ReqPayloadStatsParams* request, ::antaris_api_peer_to_peer::AntarisReturnType* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
AntarisapiPayloadController::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_PC_response_payload_stats_(AntarisapiPayloadController_method_names[7], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status AntarisapiPayloadController::Stub::PC_response_payload_stats(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::PayloadStatsResponse& request, ::antaris_api_peer_to_peer::AntarisReturnType* response) {
  return ::grpc::internal::BlockingUnaryCall< ::antaris_api_peer_to_peer::PayloadStatsResponse, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_PC_response_payload_stats_, context, request, response);
}

void AntarisapiPayloadController::Stub::async::PC_response_payload_stats(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::PayloadStatsResponse* request, ::antaris_api_peer_to_peer::AntarisReturnType* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::antaris_api_peer_to_peer::PayloadStatsResponse, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PC_response_payload_stats_, context, request, response, std::move(f));
}

void AntarisapiPayloadController::Stub::async::PC_response_payload_stats(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::PayloadStatsResponse* request, ::antaris_api_peer_to_peer::AntarisReturnType* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PC_response_payload_stats_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::antaris_api_peer_to_peer::AntarisReturnType>* AntarisapiPayloadController::Stub::PrepareAsyncPC_response_payload_statsRaw(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::PayloadStatsResponse& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::antaris_api_peer_to_peer::AntarisReturnType, ::antaris_api_peer_to_peer::PayloadStatsResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_PC_response_payload_stats_, context, request);
}

::grpc::ClientAsyncResponseReader< ::antaris_api_peer_to_peer::AntarisReturnType>* AntarisapiPayloadController::Stub::AsyncPC_response_payload_statsRaw(::grpc::ClientContext* context, const ::antaris_api_peer_to_peer::PayloadStatsResponse& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncPC_response_payload_statsRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
AntarisapiPayloadController::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< AntarisapiPayloadController::Service, ::antaris_api_peer_to_peer::PayloadStatsResponse, ::antaris_api_peer_to_peer::AntarisReturnType, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](AntarisapiPayloadController::Service* service,
             ::grpc::ServerContext* ctx,
             const ::antaris_api_peer_to_peer::PayloadStatsResponse* req,
             ::antaris_api_peer_to_peer::AntarisReturnType* resp) {
               return service->PC_response_payload_stats(ctx, req, resp);
             }, this)));
}
...
::grpc::Status AntarisapiPayloadController::Service::PC_response_payload_stats(::grpc::ServerContext* context, const ::antaris_api_peer_to_peer::PayloadStatsResponse* request, ::antaris_api_peer_to_peer::AntarisReturnType* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");

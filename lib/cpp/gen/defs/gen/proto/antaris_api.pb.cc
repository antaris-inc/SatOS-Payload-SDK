...
const uint32_t TableStruct_defs_2fgen_2fproto_2fantaris_5fapi_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::antaris_api_peer_to_peer::SesThermalStatusNtf, hw_id_of_pwr_status_),
  PROTOBUF_FIELD_OFFSET(::antaris_api_peer_to_peer::SesThermalStatusNtf, heater_temp_status_),
  PROTOBUF_FIELD_OFFSET(::antaris_api_peer_to_peer::SesThermalStatusNtf, hw_id_of_temp_status_),
...
const char descriptor_table_protodef_defs_2fgen_2fproto_2fantaris_5fapi_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\013hardware_id\030\004 \001(\005\"\264\001\n\023SesThermalStatusN"
  "tf\022\026\n\016correlation_id\030\001 \001(\005\022\031\n\021heater_pwr"
  "_status\030\002 \001(\005\022\033\n\023hw_id_of_pwr_status\030\003 \001"
  "(\005\022\032\n\022heater_temp_status\030\004 \001(\005\022\034\n\024hw_id_"
  "of_temp_status\030\005 \001(\005\022\023\n\013temperature\030\006 \001("
  "\005\".\n\024AntarisCorrelationId\022\026\n\016correlation"
  "_id\030\001 \001(\005\"U\n\021AntarisReturnType\022@\n\013return"
  "_code\030\001 \001(\0162+.antaris_api_peer_to_peer.A"
  "ntarisReturnCode*\354\001\n\021AntarisReturnCode\022\016"
  "\n\nAn_SUCCESS\020\000\022\037\n\022An_GENERIC_FAILURE\020\377\377\377"
  "\377\377\377\377\377\377\001\022\037\n\022An_NOT_IMPLEMENTED\020\376\377\377\377\377\377\377\377\377\001"
  "\022 \n\023An_OUT_OF_RESOURCES\020\375\377\377\377\377\377\377\377\377\001\022\035\n\020An"
  "_NOT_PERMITTED\020\374\377\377\377\377\377\377\377\377\001\022\036\n\021An_INVALID_"
  "PARAMS\020\373\377\377\377\377\377\377\377\377\001\022$\n\027An_INCOMPATIBLE_VER"
  "SION\020\372\377\377\377\377\377\377\377\377\001*\202\001\n\016FilePriorities\022\030\n\024FI"
  "LE_DL_PRIORITY_LOW\020\000\022\033\n\027FILE_DL_PRIORITY"
  "_NORMAL\020\001\022\031\n\025FILE_DL_PRIORITY_HIGH\020\002\022\036\n\032"
  "FILE_DL_PRIORITY_IMMEDIATE\020\003*7\n\017FileDlRa"
  "dioType\022\021\n\rFILE_DL_SBAND\020\000\022\021\n\rFILE_DL_XB"
  "AND\020\0012\253\025\n\035AntarisapiApplicationCallback\022"
  ...
  "rocessRemoteAcPwrStatusNtf\022..antaris_api"
  "_peer_to_peer.NtfRemoteAcPwrStatus\032+.ant"
  "aris_api_peer_to_peer.AntarisReturnType\""
  "\000\022\207\001\n\"PA_ProcessPstoEsFtmOperationNotify"
  "\0222.antaris_api_peer_to_peer.PstoEsFtmOpe"
  "rationNotify\032+.antaris_api_peer_to_peer."
  "AntarisReturnType\"\0002\262\020\n\033AntarisapiPayloa"
  ...
  "ReturnType\"\000\022j\n\023PC_pa_satos_message\022$.an"
  "taris_api_peer_to_peer.PaSatOsMsg\032+.anta"
  "ris_api_peer_to_peer.AntarisReturnType\"\000"
  "\022v\n\027PC_pstoes_ftm_operation\022,.antaris_ap"
  "i_peer_to_peer.PstoEsFtmOperation\032+.anta"
  "ris_api_peer_to_peer.AntarisReturnType\"\000"
  "b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_defs_2fgen_2fproto_2fantaris_5fapi_2eproto = {
  false, false, 10448, descriptor_table_protodef_defs_2fgen_2fproto_2fantaris_5fapi_2eproto, "defs/gen/proto/antaris_api.proto", 
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          hw_id_of_pwr_status_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          hw_id_of_temp_status_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SesThermalStatusNtf::_InternalSerialize(
  ...
  // int32 hw_id_of_pwr_status = 3;
  if (this->_internal_hw_id_of_pwr_status() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->_internal_hw_id_of_pwr_status(), target);
  }

  // int32 heater_temp_status = 4;
  if (this->_internal_heater_temp_status() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(4, this->_internal_heater_temp_status(), target);
  }

  // int32 hw_id_of_temp_status = 5;
  if (this->_internal_hw_id_of_temp_status() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(5, this->_internal_hw_id_of_temp_status(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:antaris_api_peer_to_peer.SesThermalStatusNtf)
  ...
  // int32 hw_id_of_pwr_status = 3;
  if (this->_internal_hw_id_of_pwr_status() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_hw_id_of_pwr_status());
  }
  ...
  // int32 hw_id_of_temp_status = 5;
  if (this->_internal_hw_id_of_temp_status() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_hw_id_of_temp_status());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:antaris_api_peer_to_peer.SesThermalStatusNtf)
  ...
  if (from._internal_hw_id_of_pwr_status() != 0) {
    _internal_set_hw_id_of_pwr_status(from._internal_hw_id_of_pwr_status());
  }
  if (from._internal_heater_temp_status() != 0) {
    _internal_set_heater_temp_status(from._internal_heater_temp_status());
  }
  if (from._internal_hw_id_of_temp_status() != 0) {
    _internal_set_hw_id_of_temp_status(from._internal_hw_id_of_temp_status());
  }
  if (from._internal_temperature() != 0) {
    _internal_set_temperature(from._internal_temperature());
  }

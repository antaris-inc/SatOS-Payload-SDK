...
def init_vars():
    ...
    g_KEEPALIVE_ENABLE=environment.get_conf(environment.g_REMOTE_ENABLE_KEY)
    g_REMOTE_FILEDOWNLOAD=environment.get_conf(environment.g_REMOTE_ENABLE_KEY)
